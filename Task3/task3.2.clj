...
(time (integrate fx_x3_5x_3 50 100 0.05))
(time (integrate fx_x3_5x_3 -100 -50 0.05))

(println "Parallel")
(time (parallel-integral fx_x3_5x_3 0 50 0.05))
(time (parallel-integral fx_x3_5x_3 50 100 0.05))
(time (parallel-integral fx_x3_5x_3 -100 -50 0.05))
